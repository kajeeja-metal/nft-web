...
import classes from '../../../components/exhibitions/edit/exhibitionroom.module.scss';

import Thumbs from '../../../public/exhibitions/images/thumblist7.png';
import Thumbs2 from '../../../public/exhibitions/images/thumblist8.png';
          ...
          <div className={classes.thumblist + ' ' + classes.active}>
            ...
            <div className={classes.thumbInfo}>                 
              ...
              <div className={classes.btnGroup}>
                ...
                <button className={`btn ${classes.btn + ' ' + button.btnTextPrimary}`}>
