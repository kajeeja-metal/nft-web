...
import classes from '../../../../components/exhibitions/exhibitions001/edit/exhibitioninfo.module.scss';
  ...
  return (
    <>  
      ...
      <div className={`row` + ' ' + classes.formGroup}>
        ...
        <div className='col-md-8'>
            <textarea type="text" className='form-control' placeholder='Optional ... ' rows="6"  value="DeCreated by SoundMint
