...
import { faPlus, faAngleRight, faEye, faSearch, faFont, faTrash } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    <>  
      <div className={`text-center`+ ' ' + classes.titleWrap}>
        <h1 className={classes.title}>Customize Exhibition Style</h1>
